                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="flex items-start">
                    <div className="shrink-0">
                      <div className="inline-block rounded-md bg-sky-500-100 p-4 text-sky-500">
                        <svg
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-muted-foreground">press@example.com</p>
                      <p className="text-muted-foreground">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-muted-foreground">bugs@example.com</p>
                      <p className="text-muted-foreground">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
